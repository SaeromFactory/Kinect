...
namespace Microsoft.Samples.Kinect.BodyBasics
{
    ...
    public class Program
        ...
        static MySqlConnection sql_connection;
            ...
            {
                string connection_str = "server=watchers.cniuibxtpu5k.ap-northeast-2.rds.amazonaws.com; user = hyunji ; password = guswl95!; database = Watcher";
                sql_connection = new MySqlConnection(connection_str);
                sql_connection.Open();

                Console.WriteLine("DB Connect string = {0}", connection_str);
                ...
                /* sqlComm.Connection = sqlConn;
                 sqlComm.CommandText = "";
                 sqlComm.Parameters.AddWithValue("@Input_x", "x좌표");
                 sqlComm.Parameters.AddWithValue("@Input_y", "y좌표");
                 sqlComm.Parameters.AddWithValue("@Input_z", "z좌표");
                 */
            }
            ...
            public static void testchectname(string name)
            {
                ...
                {
                    result = query_result.GetInt32(0);
